        ...
        <Fragment>
            ...
            >
                ...
                <div style={{ marginTop: '50px' }} className="product-img">
                    <Link
                        to={process.env.PUBLIC_URL + '/articles/' + article.id_art}
                        onClick={() => trackArticleClick(article.id_art, currentUser.id)}
                    >
                        <Carousel
                            autoPlay={false}
                            showArrows={false}
                        ...
                        >
                            {article.images.map((image, index) => (
                                <div key={index} className="slide">
                                    <img style={{ width: '200px', height: '260px' }} src={image.image} alt={article.titre} />
                                </div>
                            ))}
                        </Carousel>
                    </Link>
...
ArticleGridDsSingleTwo.propTypes = {
    ...
    article: PropTypes.shape({
        ...
        Boosting: PropTypes.bool.isRequired, // Add the Boosting prop type
    }),
