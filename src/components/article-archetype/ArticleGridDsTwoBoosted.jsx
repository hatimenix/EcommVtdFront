...
import ArticleGridDsSingleTwoBoosted from './ArticleGridDsSingleTwoBoosted';

const ArticleGridDsTwoBoosted = ({
    articles,
    categories,
    csts,
    selectedCategory,
...
ArticleGridDsTwoBoosted.propTypes = {
...
export default ArticleGridDsTwoBoosted;
